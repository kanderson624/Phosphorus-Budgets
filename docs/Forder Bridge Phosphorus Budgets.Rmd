...
### ***ASSUMPTIONS IN ODNR BUDGETS:*** 
  ...
  2. SPARROW gives an accurate measurement of P loading for wetlands <br>
  3. Literature estimates of retention are accurate <br>
...
### ***ASSUMPTIONS IN THIS BUDGET:*** 
  1. Drainage area is accurate (it accounts for only topographic drainage area) <br>
  2. Curve number is a good choice for this site on average (we chose a higher number to better account for sub-surface drainage) <br>
  ...
  6. Storm events do not change phosphorus retention dynamics
...
### ***ASSUMPTIONS IN THIS BUDGET:*** 
  1. Drainage area is accurate (it may not account for the full topographic drainage area)<br>
...
dayrain=raindata
```
Then we estimate runoff according to Pease et al. 2018 with ~7% of rainfall as surface runoff, and 31% of rainfall as subsurface runoff for a total of 38% of rainfall as runoff
```{r}
# don't need to convert rain to inches/day, but lets name it so our old code still works
dayrain$precip = dayrain$precipaccum_in
# scale up to the entire drainage area
...
monthrain$QL = monthrain$precipL * 0.38
sum(monthrain$QL)
```
...
### ***ASSUMPTIONS IN THIS BUDGET:*** 
  1. Drainage area is accurate (it's focused mostly on sub-surface drainage)<br>
  2. Curve number is a good choice for this site <br>
  3. Groundwater dynamics are captured <br>
  4. Tile drains are accounted for (they're not) <br>
  5. Nearby rainfall data is accurate for the site <br>
...
### ***ASSUMPTIONS IN THIS BUDGET:*** 
  1. Drainage area is accurate (maybe?)<br>
  2. Curve number is a good choice for this site <br>
  3. Groundwater dynamics are captured <br>
  4. Estimates of subsurface drainage are accurate <br>
  5. Nearby rainfall data is accurate for the site <br>
  6. Storm events do not change phosphorus retention dynamics
